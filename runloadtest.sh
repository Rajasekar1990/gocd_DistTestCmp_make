...
docker-compose -f jm/docker-compose.yml up -d
...
docker compose -f jm/docker-compose.yml cp /test/ master:/home/jmeter/test/
docker compose -f jm/docker-compose.yml cp /test/ slave:/home/jmeter/test/
