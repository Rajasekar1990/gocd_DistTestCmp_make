...
docker cp jm_master:/home/jmeter/jmeter-${GO_PIPELINE_COUNTER}.jtl ./jmeter-${GO_PIPELINE_COUNTER}.jtl
docker cp jm_master:/home/jmeter/htmlreport${GO_PIPELINE_COUNTER}/ ./jmeter-htmlreport${GO_PIPELINE_COUNTER}/
