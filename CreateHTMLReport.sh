...
docker cp jm_master:/home/jmeter/jmeter-${GO_PIPELINE_COUNTER}.jtl ./test/Report-jmeter-${GO_PIPELINE_COUNTER}.jtl
docker cp jm_master:/home/jmeter/htmlreport-${GO_PIPELINE_COUNTER}/ ./test/Report-htmlreport-${GO_PIPELINE_COUNTER}/
